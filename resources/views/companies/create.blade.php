    ...
    <x-slot name="header">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">
                Registrar una nueva empresa en GeoGo.
            </p>
        </div>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-xl border border-gray-100 p-6">
                ...
                <form action="{{ route('companies.store') }}" method="POST" class="space-y-6">
                    ...
                    {{-- dentro del form de crear company --}}
                    <h3 class="mt-6 mb-2 text-sm font-semibold text-gray-700">
                        Admin de la empresa
                    </h3>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="admin_name" class="w-full rounded-lg border-gray-300">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="email" name="admin_email" class="w-full rounded-lg border-gray-300">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="password" name="admin_password" class="w-full rounded-lg border-gray-300">
                        </div>
                    </div>
