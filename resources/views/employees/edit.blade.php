    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-xl border border-gray-100 p-6">
                ...
                <form method="POST"
                      action="{{ route('companies.branches.users.update', [$company, $branch, $user]) }}"
                      class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <select name="role_id"
                            ...
                            <option value="4" @if($user->role_id == 4) selected @endif>Empleado</option>
                        </select>
